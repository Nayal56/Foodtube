			...
			<div class="top-navigation">
				...
				<div class="drop-navigation drop-navigation">
				  <ul class="nav nav-sidebar">
					...
					<li class="active"><a href="drinks.php" class="menu1"><span class="glyphicon glyphicon-glass" aria-hidden="true" style="margin-top: 10px"></span><p style="margin-top: -18px; margin-left: 48px">Drinks</p></a></li>
			...
			<div class="main-grids">
				<div class="top-grids">
					<div class="recommended-info">
						<h2>Drinks Videos</h2><br>
						<?php    
	$con= mysqli_connect("127.0.0.1","root","","foodtube");

	$vid_url = "videos/";
	$result = mysqli_query($con,"SELECT * FROM videos where category='drinks'");
