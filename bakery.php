			...
			<div class="top-navigation">
				...
				<div class="drop-navigation drop-navigation">
				  <ul class="nav nav-sidebar">
					...
					<li class="active"><a href="bakery.php" class="news-icon"><span class="glyphicon glyphicon-apple" aria-hidden="true" style="margin-top: 10px"></span><p style="margin-top: -18px; margin-left: 48px">Bakery</p></a></li>
				  </ul>
				  <!-- script-for-menu -->
						<script>
			...
			<div class="main-grids">
				<div class="top-grids">
					<div class="recommended-info">
						<h2>Bakery Videos</h2><br>
						<?php    
	$con= mysqli_connect("127.0.0.1","root","","foodtube");

	$vid_url = "videos/";
	$result = mysqli_query($con,"SELECT * FROM videos where category='bakery'");
