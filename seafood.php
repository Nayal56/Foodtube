			...
			<div class="top-navigation">
				...
				<div class="drop-navigation drop-navigation">
				  <ul class="nav nav-sidebar">
					...
					<li class="active"><a href="Seafood.php" class="menu"><span class="glyphicon glyphicon-film glyphicon-tint" aria-hidden="true"></span>Sea Food</a></li>
			...
			<div class="main-grids">
				<div class="top-grids">
					<div class="recommended-info">
						<h2>Sea Food Videos</h2><br>
						<?php    
	$con= mysqli_connect("127.0.0.1","root","","foodtube");

	$vid_url = "videos/";
	$result = mysqli_query($con,"SELECT * FROM videos where category='sea food'");
