			...
			<div class="main-grids">
				<div class="top-grids">
					<div class="recommended-info">
						<h2>Recent Videos</h2><br>
						<?php    
	$con= mysqli_connect("127.0.0.1","root","","foodtube");

	$vid_url = "videos/";
	$result = mysqli_query($con,"SELECT * FROM videos ORDER BY id desc limit 0,6");
...
?>
					...
					<div class="clearfix"> </div>
								...
								<div class="top-grids">
					<div class="recommended-info">
							<h2>Popular Videos</h2><br>
						<?php    
	$con= mysqli_connect("127.0.0.1","root","","foodtube");

	$vid_url = "videos/";
	$result = mysqli_query($con,"SELECT * FROM views ORDER BY views desc limit 0,6");
	...
	while($rows=mysqli_fetch_array($result))
	{
		...
		$vide = $rows['videoid'];
			$results = mysqli_query($con,"SELECT * FROM videos where id='$vide'");
